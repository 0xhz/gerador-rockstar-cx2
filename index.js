...
function trocar() {
        ...
        try {
            (async () => {
                ...
                console.log(" ╚═╝░░╚═╝░╚════╝░░╚════╝░╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚═╝".yellow)
                console.log("")
                console.log(`   ${'discord.gg/hardzy'.underline.white}`)
                console.log("")
                console.log(`[`.green, `/`.yellow, `]`.green, ` Valid Accounts:`.green, `${contas}`.brightWhite)
                console.log(`[`.red, `<`.yellow, `]`.red, ` Invalid Accounts:`.red, `${falhas}`.brightWhite)
